...
{
    [TrackClipType(typeof(JinglePlayableAsset))]
    public class JingleTrack : TrackAssetCustom
    {
        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            JinglePlayableAsset asset = null;

            foreach (var clip in GetClips())
            {
                asset = clip.asset as JinglePlayableAsset;
    ...
    [CustomTimelineEditor(typeof(JingleTrack))]
    public class JingleTrackEditor : TrackEditor
    {
